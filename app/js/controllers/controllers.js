...
phonecatAppControllers.controller('HeadListCtrl',['$scope','$http','$location','menSection','mySessionService','$rootScope',function($scope,$http,$location,menSection,mySessionService,$rootScope){
     ...
     //    });
        ...
        $scope.showName=mySessionService.showName;
            console.log($scope.userName+", and "+$scope.showName);
    });

        $rootScope.$on('signUpUser', function () {
		...
		$scope.showMenu = function() {
        	...
        	$scope.showNameMenu = true;
        };

        $scope.accountDetail = function() {
            $scope.showNameMenu=!$scope.showNameMenu;
...
phonecatAppControllers.controller('singUpValidation',['$scope','$http','$location','mySessionService','$rootScope', function($scope,$http,$location,mySessionService,$rootScope){
    ...
    $scope.submitForm = function(type) {
    	...
    	mySessionService.userName=$scope.uName;
    	mySessionService.password=$scope.pass;

    	$rootScope.$broadcast('signUpUser');
    	$location.path("/");
    }
	}]);
...
phonecatAppControllers.controller('logInValidation',['$scope','$location','userLists','mySessionService','$rootScope', function($scope,$location,userLists,mySessionService,$rootScope){
